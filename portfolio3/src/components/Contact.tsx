                            ...
                            <div className="contact-info__list">
                                <div className="contact-info__item">
                                    ...
                                    <div className="contact-info__content">
                                        ...
                                        <a href={`mailto:${profile.contact.altEmail}`} className="contact-info__value contact-info__value--alt">
                                ...
                                <div className="contact-info__item">
                                    ...
                                    <div className="contact-info__content">
                                        ...
                                        <span className="contact-info__value">{profile.contact.phone}</span>
                                    </div>
                                </div>
